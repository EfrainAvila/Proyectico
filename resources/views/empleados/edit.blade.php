...
@section('contenido_vistas')
    ...
    <form class="form-horizontal"  method="post" action="{{ url('empleados/'.$empleado->EmployeeId) }}" autocomplete="off">
        @method('PUT')
        @csrf
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
                <input id="textinput" value="{{ $empleado->FirstName }}" name="nombre" type="text" placeholder="" class="form-control input-md" required="">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
            <input id="textinput" value="{{ $empleado->LastName }}" name="apellido" type="text" placeholder="" class="form-control input-md" required="">
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
            <input id="datepicker" name="contrato" value="{{ $empleado->HireDate->format('Y-m-d') }}" type="text" placeholder="" class="datepicker form-control input-md" required="">
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
            <input id="" name="nacimiento" value="{{ $empleado->BirthDate->format('Y-m-d') }}" type="text" placeholder="" class="datepicker form-control input-md" required="">
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
            <input id="textinput" name="email" value="{{ $empleado->Email }}" type="text" placeholder="" class="form-control input-md" required="">
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
            <input id="textinput" name="direccion" value="{{ $empleado->Address }}" type="text" placeholder="" class="form-control input-md" required="">
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
            <input id="textinput" name="ciudad" value="{{ $empleado->City }}" type="text" placeholder="" class="form-control input-md" required="">
